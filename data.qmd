...
Your []() file is how you will load and clean your data. Here is a an example of a very simple one.

```{r}
library(readr)
data <- read_csv(here::here("dataset", "fatal-police-shootings-data.csv"))
```
