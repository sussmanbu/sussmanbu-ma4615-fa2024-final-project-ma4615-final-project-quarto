...
server <- function(input, output) {
  ...
  data <- read_rds("https://github.com/sussmanbu/ma-4615-fa24-final-project-group-1/blob/main/subset_data.rds")
...
data <- tryCatch({
  readRDS("dataset/subset_data.rds")
}, error = function(e) {
  stop("Error: Could not load the dataset. Check the URL or data format.")
})
